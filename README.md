...
- [x]  Use a styling or component library for part of or all of your application. (Pick at least 1 of: styled-components or [Reactstrap](https://react-bootstrap.github.io/)).
...
- [x]  Use the [GraphQL Endpoint](https://rickandmortyapi.com/documentation/#graphql) with multiple search fields.
